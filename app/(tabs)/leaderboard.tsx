  ...
  return (
    ...
    >
      <View
        style={[
          styles.avatar,
          { width: radius, height: radius, borderColor: medalColor },
        ]}
      >
      ...
      <View style={{ alignItems: "center" }}>
        <View style={styles.podiumRankWrap}>
          ...
          <ThemedText style={[styles.podiumRankText, { color: medalColor }]}>
            #{rank}
          </ThemedText>
        </View>
...
const LeaderboardItem = ({
  ...
  const { container, color } = medalStyles[rank - 1] || {
    container: {},
    color: "#889",
  };
  ...
  return (
    <Animated.View style={{ transform: [{ scale }], marginBottom: 10 }}>
      <TouchableOpacity
        ...
        accessibilityLabel={`Hạng ${rank}: ${
          item.userName
        }, ${item.totalCO2Emission.toFixed(2)} kg CO₂`}
      >
        ...
        <View style={styles.userBlock}>
          <View style={styles.avatarSm}>
            <ThemedText style={styles.avatarSmText}>
...
const ScreenWrapper = ({
  ...
  <View style={[{ flex: 1, backgroundColor: rankColors.bg }, style]}>
    {children}
  </View>
);
...
const styles = StyleSheet.create({
  ...
  emissionValue: {
    fontSize: 16,
    fontWeight: "900",
    color: rankColors.green700,
  },
  emissionUnit: {
    fontSize: 11,
    color: rankColors.green600,
    marginLeft: 3,
    marginBottom: 2,
  },
});
